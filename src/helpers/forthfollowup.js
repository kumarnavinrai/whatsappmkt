...
function sendLinkToPreLoadBkp(){
    ...
    con.query('select * from links where user ='+ allusers[0]?.id + ' AND f4_sent = 0 AND participate = 0 AND connection_accepted = 1 ORDER BY id ASC', function (errql, recordsetl) {
